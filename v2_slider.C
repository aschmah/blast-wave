...
private:
    ...
    Double_t individual_chi2_ana[N_masses][2] = {0.0};
    Double_t best_individual_chi2_per_point_ana[N_masses][2] = {0.0};
    Double_t N_individual_chi2_ana[N_masses][2] = {0.0};
...
TBlastWaveGUI::TBlastWaveGUI() : TGMainFrame(gClient->GetRoot(), 100, 100)
{
    ...
    TString ComboEnergyLabel[10] = {"7.7    GeV","11.5  GeV","14.6  GeV","19.6  GeV","27.0  GeV","39.0  GeV","62.4  GeV","200   GeV", "2760 GeV", "5020 GeV"};
